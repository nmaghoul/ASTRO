...
gamma = [.01]
for i in range(120):
    gamma.append(gamma[i] + .01)
n_components = [2, 5, 7, 10, 12, 15, 20]
...
### Change here
    #gamma = [0.01, 0.03 ,0.05 ,0.07, 0.09 ,0.1, 0.3, 0.5, 0.7, 0.9, 1.2]
    accuracy = []
    ...
    plt.title('When n_components = ' + str(n_components[n_component]))
    plt.xlabel('gamma')
    plt.ylabel('accuracy')
    plt.show()
